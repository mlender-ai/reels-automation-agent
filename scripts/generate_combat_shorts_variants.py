...
VARIANTS: list[VariantDefinition] = [
    ...
    VariantDefinition(
        ...
        hook_text="한 장면만 보여줘도 기억에 남는다",
        description="에디토리얼형 포맷으로, 자막은 줄이고 카피 밀도를 낮춰서 무드와 잔상을 남기는 버전입니다.",
        hashtags="#복싱 #격투기 #에디토리얼 #숏츠 #하이라이트 #boxing #editorialcut",
        subtitle_preset="clean",
        score=95.8,
        title_card=OverlayCard(
            text="한 장면만으로도 충분히 기억에 남는다",
            width=848,
            height=206,
            font_size=43,
            horizontal_padding=34,
    ...
    VariantDefinition(
        ...
        hook_text="코치는 마지막보다 준비 동작을 먼저 본다",
        description="코치 노트형 포맷으로, 한 줄씩 핵심 포인트를 짚어주는 정보성 톤의 숏츠 버전입니다.",
        hashtags="#복싱 #격투기 #코치노트 #전술 #숏츠 #boxingcoach #breakdown",
        subtitle_preset="clean",
        score=95.2,
        title_card=OverlayCard(
            text="코치는 마지막보다 준비 동작을 먼저 본다",
            width=850,
            height=206,
            font_size=42,
            horizontal_padding=34,
