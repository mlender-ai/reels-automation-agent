...
- return JSON only
- write every issue `title` and `body` in natural Korean that a product owner or engineer in Korea can read immediately
- keep JSON keys in English, but keep all user-facing prose in Korean
...
- use Korean section headings in the markdown body, for example `## 문제`, `## 근거`, `## 해결 방향`, `## 기대 효과`
